        ...
        <div className="register">
            <div className="register-form">
                ...
                <form id="login">
                    ...
                    <input type="button" className="btn btn-primary form-control" value="Login" onClick={handleLogin}/>
                </form>
                <button className="btn btn-primary form-control" onClick={handleProvider} >Continue with Google</button>
            </div>
